...
namespace Game
{
    ...
    public class SunShineNativeShare : MonoBehaviour
    {
        ...
        public static string fileProviderName = "cn.budapp.biyoudideshijie.fileprovider";

        private INativeShare _nativeShare;

        public static SunShineNativeShare instance;

        private static AndroidJavaClass _keepShareFragment = new AndroidJavaClass("com.SmileSoft.unityplugin.Share.ShareFragment");
        ...
        public static bool IsItAndroidPlatform()
        {
            ...
            result = true;
#endif
            //Debug.LogError($"share sdk IsItAndroidPlatform = {result}");
            return result;
        }
        ...
        public static bool IsItIosPlatform()
        {
            ...
            result = true;
#endif
            //Debug.LogError($"share sdk IsItIosPlatform = {result}");
            return result;
        }
