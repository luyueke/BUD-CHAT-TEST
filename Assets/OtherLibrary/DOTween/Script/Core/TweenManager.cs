...
namespace DG.Tweening.Core
{
    internal static class TweenManager
    {
        ...
        internal static bool hasActiveTweens, hasActiveDefaultTweens, hasActiveLateTweens, hasActiveFixedTweens, hasActiveManualTweens, hasActiveNetFrame;
        internal static int totActiveTweens, totActiveDefaultTweens, totActiveLateTweens, totActiveFixedTweens, totActiveManualTweens, totActiveNetFrame;
        ...
        internal static void SetUpdateType(Tween t, UpdateType updateType, bool isIndependentUpdate)
        {
            ...
            if (t.updateType == UpdateType.Normal) {
                ...
                case UpdateType.Late:
                    ...
                    break;
                case UpdateType.NetFrame:
                    totActiveNetFrame--;
                    hasActiveNetFrame = totActiveNetFrame > 0;
                    break;
                default: // Manual
        ...
        internal static int DespawnAll()
        {
            ...
            hasActiveTweens = hasActiveDefaultTweens = hasActiveLateTweens = hasActiveFixedTweens = hasActiveManualTweens = hasActiveNetFrame = false;
            totActiveTweens = totActiveDefaultTweens = totActiveLateTweens = totActiveFixedTweens = totActiveManualTweens = totActiveNetFrame = 0;
