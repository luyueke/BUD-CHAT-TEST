...
namespace DG.Tweening.Core
{
    ...
    public class DOTweenComponent : MonoBehaviour, IDOTweenInit
    {
        ...
        public void NetFrameUpdate(float deltaTime)
        {
            if (TweenManager.hasActiveNetFrame && Time.timeScale > 0) {
                // Debug.Log($"zzjj NetFrameUpdate {deltaTime}");
                TweenManager.Update(UpdateType.NetFrame, deltaTime * DOTween.timeScale, deltaTime * DOTween.timeScale);
            }
        }
