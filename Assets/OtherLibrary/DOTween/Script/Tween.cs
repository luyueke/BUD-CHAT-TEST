...
#pragma warning restore 1591
        ...
        #region Net Frame
        public bool IsNetFrame()
        {
            return updateType == UpdateType.NetFrame;
        }

        public void GotoPositionWithFrame(float frameTime)
        {
            if (!IsNetFrame()) return;
            var newPos = frameTime % duration;
            position = newPos;
            this.Goto(frameTime, isPlaying);
        }
        #endregion
