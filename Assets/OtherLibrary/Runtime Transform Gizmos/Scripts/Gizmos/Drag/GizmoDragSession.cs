...
namespace RTG
{
    public abstract class GizmoDragSession : IGizmoDragSession
    {
        ...
        protected Vector3 _scaleDragOffset;
        ...
        public Vector3 ScaleDragOffset { get { return _scaleDragOffset; } }
        ...
        public void End()
        {
            if (IsActive)
            {
                ...
                _totalDragOffset = _relativeDragOffset = _scaleDragOffset = Vector3.zero;
