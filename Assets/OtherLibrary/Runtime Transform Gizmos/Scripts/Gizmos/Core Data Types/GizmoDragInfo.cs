...
namespace RTG
{
    public struct GizmoDragInfo
    {
        ...
        public Vector3 ScaleOffset { get { return _scaleOffest; } set { _scaleOffest = value; } }
        ...
        public void Reset()
        {
            ...
            _totalOffset = _relativeOffset = _scaleOffest = Vector3.zero;
