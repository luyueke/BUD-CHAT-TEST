...
namespace RTG
{
    public static class TransformEx
    {
        ...
        public static void SetWorldScaleEx(this Transform transform, Vector3 scaleOffset)
        {
            Vector3 worldScale = transform.lossyScale;
            worldScale += scaleOffset;
            transform.SetWorldScale(worldScale);
        }

        public static void ScaleFromPivot(this Transform transform, Vector3 scaleFactor, Vector3 pivot, Vector3 scaleOffset)
        {
            Vector3 worldScale = transform.lossyScale;
            worldScale += scaleOffset;
            transform.SetWorldScale(worldScale);
