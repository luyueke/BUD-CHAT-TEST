...
namespace Funly.SkyStudio
{
    ...
    public class TimeOfDayController : MonoBehaviour
    {
        ...
        public List<Texture> moonTextures;
        ...
        public void RemoveLightCullingMask(int target)
        {
            if (sunLight)
            {
                ...
                if (sun)
                {
                    sun.cullingMask = sun.cullingMask & ~(1 << target);
                }
            }
            if (moonLight)
            {
                var moon = moonLight.GetComponent<Light>();
                if (moon)
                {
                    moon.cullingMask = moon.cullingMask & ~(1 << target);
                }
            }
        }

        public void AddLightCullingMask(int target)
        {
            if (sunLight)
            {
                var sun = sunLight.GetComponent<Light>();
