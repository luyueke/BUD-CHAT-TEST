...
public class BuglyInit : MonoBehaviour
{
		...
		private const string BuglyAppID = "be8742cc2a";
	#elif UNITY_IOS
		private const string BuglyAppID = "d679a44725";
	#endif
#else
	#if UNITY_ANDROID
		/// <summary>
		...
		/// </summary>
		/// <example>A real App ID looks like this: 90000xxxx</example>
		private const string BuglyAppID = "a92c199efa";
	#elif UNITY_IOS
		private const string BuglyAppID = "2190a4cb59";
	#endif
#endif
