        ...
        private static void StartGravityEngine(Token[] tokens = null)
        {
            ...
            KSOutLaunchOption launchOption = KS.GetLaunchOptionSync();
                ...
                if (launchOptions != null)
                {
                    ...
                    ReportSuperProperties(launchOptions.scene);
                }
                else
                {
                ...
                var launchScene = "";
                bool successLaunchInfo;
                if (SyncHelper.GetLaunchInfoSync(out successLaunchInfo, out launchQuery, out launchScene))
                {
                    Debug.Log($"Success: {successLaunchInfo}, Scene: {launchScene}, Query: {launchQuery?.ContainsKey("type")}");
                }
                else
                {
