...
namespace xasset.tests
{
    public class RuntimeTest
    {
        ...
        public IEnumerator ActionAsync()
        {
            ...
            Downloader.CreateHandler = request => new DownloadContentRequestHandlerHWR(request);
            Downloader.Pause();

            DownloadContentRequestHandlerHWR.Username = null;
            DownloadContentRequestHandlerHWR.Password = null;
            DownloadContentRequestHandlerHWR.bufferSize = 1024 * 10;
