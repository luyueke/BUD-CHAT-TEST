...
namespace xasset.editor
{
    internal class DependenciesTreeView : TreeView
    {
        ...
        protected override void ContextClickedItem(int id)
        {
            ...
            menu.AddItem(new GUIContent("Copy"), false,
                data =>
                {
                    ...
                    foreach (var asset in assets) sb.AppendLine($"\"{asset}\",");
        ...
        protected override TreeViewItem BuildRoot()
        {
            ...
            if (string.IsNullOrEmpty(title)) title = "Dependencies";
            ...
            foreach (var assetPath in assetPaths)
                if (topOnly)
                    ...
                    {
                        if (dependency == assetPath || Bundler.ExcludeFiles.Exists(dependency.Contains) ||
