    ...
    public class AssetTreeView : TreeView
    {
        ...
        private static MultiColumnHeaderState.Column[] GetColumns()
        {
            var retVal = new[]
            {
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("AssetPack"),
                    minWidth = 64,
                    width = 96,
                    headerTextAlignment = TextAlignment.Left,
                    canSort = true,
        ...
        protected override TreeViewItem BuildRoot()
        {
            ...
            foreach (var asset in assets)
            {
                ...
                var item = new AssetTreeViewItem(asset, 0)
                {
                    ...
                    pack = _manifest.packs.Length > 0 ? _manifest.packs[bundle.pack].file : "unpacked"
                };
                root.AddChild(item);
                var dependencies = Bundler.GetDependencies(asset);
        ...
        {
            for (var i = 0; i < args.GetNumVisibleColumns(); ++i) CellGUI(args.GetCellRect(i), (AssetTreeViewItem) args.item, args.GetColumn(i), ref args);
        }
        ...
        private void CellGUI(Rect cellRect, AssetTreeViewItem item, int column, ref RowGUIArgs args)
        {
            ...
            switch (column)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    DefaultGUI.Label(cellRect, Utility.FormatBytes(item.size), args.selected,
                        args.focused);
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    DefaultGUI.Label(cellRect, Utility.FormatBytes(item.bundleSize), args.selected,
                        args.focused);
                    break;
            }
        }
