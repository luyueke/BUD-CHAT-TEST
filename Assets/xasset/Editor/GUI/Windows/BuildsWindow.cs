...
namespace xasset.editor
{
    public class BuildsWindow : EditorWindow, IDependenciesEditor
    {
        ...
        public void OnGUI()
        {
            ...
            if (_dependenciesTreeViewState == null) _dependenciesTreeViewState = new TreeViewState();
        ...
        {
            if (_dependenciesTreeView == null) return;
        ...
        private void Reload()
        {
            ...
            _build.parameters.build = _build.name;
        ...
        private void Initialize()
        {
            ...
            _builds.AddRange(Builder.FindAssets<Build>());
            if (_builds.Count > 0)
            {
                _build = _builds[selected];
                Reload();
