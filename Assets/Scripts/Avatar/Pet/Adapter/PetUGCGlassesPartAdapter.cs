...
namespace Game.Pet {
    public class PetUGCGlassesPartAdapter : PetNormalPartAdapter , IUGCPartAdapter{
        ...
        public PetUGCGlassesPartAdapter(GameObject _avatar) : base(_avatar) {
            propSkinRoot = _avatar.transform.Find("Pet001 Root/Pet001 Spine/Pet001 Spine1/pet001 Head/pet_glasses_01/pet_glasses_02").gameObject;
        }
