...
namespace Game.Pet {
    class PetUGCBackpackPartAdapter : PetNormalPartAdapter , IUGCPartAdapter{
        ...
        public PetUGCBackpackPartAdapter(GameObject _avatar) : base(_avatar) {
            propSkinRoot = _avatar.transform.Find("Pet001 Root/Pet001 Spine/Pet001 Spine1/pet_back_01/pet_back_02").gameObject;
        }
