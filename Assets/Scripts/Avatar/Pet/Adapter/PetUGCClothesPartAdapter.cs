...
namespace Game.Pet
{
    ...
    class PetUGCClothesPartAdapter : BonePartAdapter {

        private string curUrl = string.Empty;
        public PetUGCClothesPartAdapter(GameObject _avatar, Dictionary<string, Transform> bones) : base(_avatar, bones){
        ...
        public override void ResetCurrentID()
        {
         ...
         public override void UGCPutOn(string id, string url,int ugcStyle, Action suc = null)
        {
