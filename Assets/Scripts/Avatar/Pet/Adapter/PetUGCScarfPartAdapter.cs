...
namespace Game.Pet {
    class PetUGCScarfPartAdapter : PetNormalPartAdapter , IUGCPartAdapter{
        ...
        public PetUGCScarfPartAdapter(GameObject _avatar) : base(_avatar) {
            propSkinRoot = _avatar.transform.Find("Pet001 Root/Pet001 Spine/Pet001 Spine1/pet_necklace_01/pet_necklace_02").gameObject;
        }
