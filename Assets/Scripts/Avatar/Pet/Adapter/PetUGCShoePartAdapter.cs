...
using xasset;
namespace Game.Pet {
    public class PetUGCShoePartAdapter : BonePartAdapter {
        private string curUrl = string.Empty;
        public PetUGCShoePartAdapter(GameObject _avatar, Dictionary<string, Transform> bones) : base(_avatar, bones){
