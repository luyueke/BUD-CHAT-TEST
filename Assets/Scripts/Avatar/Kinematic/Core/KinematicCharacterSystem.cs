...
namespace Game.KinematicCharacter
{
    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        // BUD:进行外部地面检测
        public static Action DoGroundDetect;
        ...
        public static void SinglePreSimulationInterpolationUpdate(KinematicCharacterMotor motor)
        {
        ...
        public static void SingleSimulate(KinematicCharacterMotor motor, float deltaTime)
        {
            ...
            motor.Transform.SetPositionAndRotation(motor.TransientPosition, motor.TransientRotation);
            motor.CharacterController.AfterCharacterMove();
        }

        public static void SinglePostSimulationInterpolationUpdate(KinematicCharacterMotor motor)
        {
...
#pragma warning disable 0162
            ...
            {
                if (motors[i].IsOnSimulate && motors[i].CharacterController.IsInitIKController())
                {
            ...
            for (int i = 0; i < characterMotorsCount; i++)
            {
                ...
                if (motor.IsOnSimulate&& motors[i].CharacterController.IsInitIKController())
                {
                    motor.UpdatePhase2(deltaTime);
                }
