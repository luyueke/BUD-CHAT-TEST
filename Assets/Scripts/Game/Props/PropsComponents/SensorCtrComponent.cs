...
{
	public class SensorCtrComponent : BaseComponent, IComponentSerializer
	{
		...
		{
			if (componentData.CmpData.TryUnpack<PSensorCtrComponentData>(out var pbBodyData))
			{
		...
		{
			var pbBodyData = new PSensorCtrComponentData();
		...
		{
			var component = new SensorCtrComponent();
