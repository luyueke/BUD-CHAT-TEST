...
namespace Game.Props.PropsManagers.AIGames.AIPark.FSM
{
    ...
    public class LinkEmoteState : AIChapterState
    {
        ...
        public LinkEmoteState(AIPark_CharacterBehaviour character, AIPark_ChapterData data = null) : base(character, data) 
        { 
            _isLinked = false;
        }
        ...
        public void StartLinkEmote(string emoteId, bool bSelfActive = false)
        {
            ...
            {
                // 玩家发起的连接
                AIBuddyAvatarController.Inst.AddGameAIBuddyForPark(_character._npcStateController);
        ...
        private void StopLinkEmote()
        {
            ...
            if (npcStateCtr.emoteOPId == AccountDataManager.Inst.Uid)
            {
                ...
                AIBuddyAvatarController.Inst.RemoveGameAIBuddyForPark(_character._npcStateController);
            }
