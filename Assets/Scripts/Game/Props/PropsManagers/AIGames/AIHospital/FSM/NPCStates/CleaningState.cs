...
namespace Game.Props.PropsManagers.AIGames.AIHospital.FSM
{
    ...
    public class CleaningState : AIChapterState
    {
        ...
        public CleaningState(AIHospital_CharacterBehaviour character, AIHospital_ChapterData data) : base(character, data) { }

        #region 清洁坐标点
        private List<HospitalNpcTransData> ToiletCleaningPoints = new List<HospitalNpcTransData>()
        {
        ...
        private List<HospitalNpcTransData> CorridorCleaningPoints = new List<HospitalNpcTransData>()
        {
            new HospitalNpcTransData()
            {
