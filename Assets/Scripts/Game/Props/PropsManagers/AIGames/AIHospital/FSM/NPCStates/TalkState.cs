...
namespace Game.Props.PropsManagers.AIGames.AIHospital.FSM
{
    ...
    public class TalkState : AIChapterState
    {
        ...
        private AIHospital_CharacterBehaviour _targetCharacter;
        private HospitalNpcTransData _curTalkTransData;
        private string _talkTargetId;
        public TalkState(AIHospital_CharacterBehaviour character, AIHospital_ChapterData data) : base(character, data) { }
        public override void OnEnter()
        {
            ...
            _targetCharacter = AIHospital_CharacterManager.Inst.GetNpc(_talkTargetId);
        }
        ...
        private void OnReachedTarget()
        {
            ...
            var npcState = AIHospital_CharacterManager.Inst.GetNpcCurrentState(_chapterData.talkTo);
