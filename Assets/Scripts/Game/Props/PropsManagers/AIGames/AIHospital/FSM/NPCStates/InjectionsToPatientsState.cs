...
namespace Game.Props.PropsManagers.AIGames.AIHospital.FSM
{
    ...
    public class InjectionsToPatientsState : AIChapterState
    {
        ...
        public InjectionsToPatientsState(AIHospital_CharacterBehaviour character, AIHospital_ChapterData data) : base(character, data) { }

        private HospitalNpcTransData DoInjectionTransData = new HospitalNpcTransData()
        {
        ...
        private void OnReachedTarget()
        {
            ...
            {
                if (sittingState.GetChairType() == AIHospital_ChairBehaviour.Hospital_ChairType.Injections)
                {
                    DoInjections();
                    return;
                }
