...
namespace Game.Props.PropsBehaviours.AIHospital
{
    /// <summary>
    /// 移动方式
    /// </summary>
    ...
    public class KCCPathFollower : MonoBehaviour
    {
        ...
        public bool MoveToPosition(Vector3 targetPosition, Action onDestinationReached = null)
        {
        ...
        public bool StartFollowingPreviewedPath(Action onDestinationReached = null)
        {
        ...
        public bool RecalculatePath()
        {
            ...
            return MoveToPosition(_targetPosition, _onDestinationReachedCallback);
        }
        ...
        {
            LoggerUtils.Log("KCCPathFollower: 到达目的地");
            _isFollowingPath = false;
