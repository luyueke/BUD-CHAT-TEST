...
{
    public class AIHospital_MedicineCabinetBehaviour : AIHospital_BaseDoorBehaviour
    {
        public Vector3 pos;
        public Vector3 rot;
        ...
        {
            AIGameSoundUtils.Inst.PlaySound(AIHospitalConfig.SOUND_MED_OPEN_DOOR, this.gameObject);
        }
        protected override void PlayCloseSound()
        {
            AIGameSoundUtils.Inst.PlaySound(AIHospitalConfig.SOUND_MED_CLOSE_DOOR, this.gameObject);
        }
    }
}
