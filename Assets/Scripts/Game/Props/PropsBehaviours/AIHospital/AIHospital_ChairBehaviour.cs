...
{
    public class AIHospital_ChairBehaviour : AIHospital_BaseInteractiveBehaviour
    {
        public Hospital_ChairType _chairType;
        public Vector3 pos;
        public Vector3 rot;
        private string _curEmoteId;
        public IList<int> _neighbor;

        public override bool AllowClickInEmoteLink => _chairType == Hospital_ChairType.WaitingRoom;


        public enum Hospital_ChairType
        {
            Default = 0,
            Injections = 1, // 候诊室
            WaitingRoom = 2, //候诊室
        ...
        public override void OnInitByCreate()
        {
            ...
            pos = dataComp.Pos;
            rot = dataComp.Rot;
            _chairType = (Hospital_ChairType)dataComp.Index;
        ...
        private string GetInteractiveEmoteId()
        {
            switch (_chairType)
            {
                case Hospital_ChairType.Injections:
                    return "40200469";
                case Hospital_ChairType.WaitingRoom:
                    return "40200402";
                case Hospital_ChairType.Dean:
                    return "40200464";
            }
            return "";
        }
        ...
        public bool CheckNeighborOccupied()
        {
            ...
            {
                var chair = GlobalNodeManager.Inst.Get<AIHospital_ChairManager>().GetBevsByUID(uid);
