...
{
    [EnterModel(EnterGameModel.AIPark)]
    public class AIParkEnterModelController : AIGameEnterModelController
    {
        public override void StartAIGame()
        {
            this._localMetaJsonPath = "Assets/Loadable/UI/UIPanel/AIParkGame/AIParkConfig/AIPark_MapData.json";
            base.StartAIGame();
