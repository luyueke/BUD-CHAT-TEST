...
{
	[Serializable]
	public sealed partial class UgcScreenGraphics : EsRowData
	{
		[EsKeyField]
		[SerializeField]
		private string _Id;
		...
		[SerializeField]
		private int _HSize;
		public int HSize => _HSize;

		[SerializeField]
		private int _LSize;
		public int LSize => _LSize;


		public UgcScreenGraphics()
		{
		}
		...
		private void Parse(List<string> cells, int column)
		{
			...
			EsParser.TryParse(cells[column++], out _HSize);
			EsParser.TryParse(cells[column++], out _LSize);
		}
#endif
