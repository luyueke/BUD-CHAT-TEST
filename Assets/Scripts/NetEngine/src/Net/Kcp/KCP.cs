...
namespace NetEngine.src.Net.Kcp
{
    public class Kcp
    {
        ...
        public UInt32 Flush(bool ackOnly)
        {
            ...
            UInt64 change = 0;
            UInt64 lostSegs = 0;
            UInt64 fastRetransSegs = 0;
            UInt64 earlyRetransSegs = 0;
            ...
            for (var k = 0; k < snd_buf.Count; k++)
            {
                ...
                if (needsend)
                {
                    ...
                    Buffer.BlockCopy(segment.data.RawBuffer, segment.data.ReaderIndex, buffer, writeIndex,
                        segment.data.ReadableBytes);
