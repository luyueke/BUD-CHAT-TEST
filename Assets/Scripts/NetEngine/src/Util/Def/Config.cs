...
namespace NetEngine.src.Util.Def
{
    [Serializable]
    public static class Config
    {
        private static int pingTimeout = 3000; //双心跳都规定3s超时时间
        ...
        // private static string keyFrameUrl = "";
        ...
        // public static string KeyFrameUrl
        // {
        //     get => keyFrameUrl;
        //     set => keyFrameUrl = value;
        // }
        ...
        public static void Assign(ConfigPara config)
        {
            ...
            // Port.TcpRelayPort3 = config.KeyFramePort;
    ...
    public static class Port
    {
        ...
        private static int _tcpRelayPort3 = _tcpRelayPort + 3000;
        ...
        public static int TcpRelayPort
        {
            get { return _tcpRelayPort; }
            set { _tcpRelayPort = value; }
        }

        public static int TcpRelayPort2
        {
            get { return _tcpRelayPort2; }
            set { _tcpRelayPort2 = value; }
        }

        // public static int TcpRelayPort3
        // {
        //     get { return _tcpRelayPort3; }
        //     set { _tcpRelayPort3 = value; }
        // }

        public static int UdpRelayPort
        {
            get { return _udpRelayPort; }
            set { _udpRelayPort = value; }
        }
    ...
    {
        private const string _version = "v0.3.0";
