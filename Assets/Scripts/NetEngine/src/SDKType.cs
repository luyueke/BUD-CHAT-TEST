...
namespace NetEngine
{
    ...
    {
        public ResponseEvent(ErrorCode code)
        {
            this.Code = code;
            // this.Msg = "";
            this.Seq = "";
        ...
        public ResponseEvent(ErrorCode code, string seq, Object data)
        {
            this.Code = code;
            // this.Msg = msg;
            this.Seq = seq;
    ...
    public class ConfigPara
    {
        ...
        // public int KeyFramePort { get; set; }
        // public ERoomSyncType RoomSyncType { get; set; }
    }
