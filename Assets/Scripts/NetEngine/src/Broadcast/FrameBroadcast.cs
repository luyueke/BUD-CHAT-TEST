...
namespace NetEngine.src.Broadcast
{
    ...
    public class FrameBroadcast
    {
        ...
        public void Push(BroadcastEvent eve, NetEngine.Room room)
        {
        ...
        public void RetryFill(NetEngine.Room room)
        {
        ...
        private void Fill(int beginFrameId, int endFrameId, NetEngine.Room room)
        {
        //     if (!room.IsInRoom())
        //     {
        //         return;
