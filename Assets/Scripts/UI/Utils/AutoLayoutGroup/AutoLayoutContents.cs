...
public class AutoLayoutContents : MonoBehaviour
{
    ...
    {
        LayoutChildrenObjectsSync(parent);
    }

    public virtual bool LayoutChildrenObjectsSync(GameObject parent = null) {
    ...
    public virtual async Task<bool> LayoutChildrenObjectsAsync(GameObject parent = null)
    {
        await Task.Yield();
        return LayoutChildrenObjectsSync(parent);
    }
