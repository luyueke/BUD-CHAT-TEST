...
public class CreateDestroyUndoHelper:BaseUndoHelper
{
    ...
    {
        GamePropNodeManager.Inst.PopItemFromSecondCache(helpData.targetNode);
        ...
        {   
            ...
            // SceneControlManager.Inst.SelectEntity(nodeBehaviour.entity);
            InputHandlerManager.Inst.SelectEntity(nodeBehaviour.entity);
        }else{
    ...
    {
        GameObject gameObject = helpData.targetNode;
        GamePropNodeManager.Inst.DestroyNodeToSecondCache(gameObject);
    ...
    {
        return ((helpData.createUndoMode == (int)UndoRedoConfig.CreateUndoMode.Create || helpData.createUndoMode == (int)UndoRedoConfig.CreateUndoMode.Duplicate) && helpData.targetNode != null);
    }
