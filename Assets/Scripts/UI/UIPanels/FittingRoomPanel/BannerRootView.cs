...
public class BannerRootView : MonoBehaviour, ILowMemoryInterface
{
    [HideInInspector]
    ...
    public BannerRootItem BannerLeft;
    public BannerRootItem BannerCenter;
    public BannerRootItem BannerRight;
    private List<ShapeBannerData> m_Infos;
    [HideInInspector]
    ...
    public Vector2 LeftPosition = new Vector2(-1200, 0);
    public Vector2 CenterPosition = new Vector2(0, 0);
    public Vector2 RightPosition = new Vector2(1200, 0);
    ...
    public void SetBanner(List<ShapeBannerData> infos)
    {
        ResetAll();
        m_Infos = infos;
        SetBannerToggle();
    ...
    public void BeginDrag(BannerRootItem item, Vector2 delta)
    {
        if (m_Infos == null)
        {
            return;
    ...
    public void Drag(BannerRootItem item, Vector2 delta)
    {
        if (m_Infos == null)
        {
            return;
    ...
    public void EndDrag(BannerRootItem item, Vector2 delta)
    {
        if (m_Infos == null)
        {
            return;
    ...
    public ShapeBannerData GetInfo(int index)
    {
