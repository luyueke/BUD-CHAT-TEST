...
public class UgcAnimToneStoreListAdapter : GridAdapter<GridParams, UgcAnimToneStoreListItemHolder>
{
    ...
    protected override void UpdateCellViewsHolder(UgcAnimToneStoreListItemHolder newOrRecycled)
    {
...
public class UgcAnimToneStoreListItemHolder : CellViewsHolder
{
    public UgcAnimToneStoreItemView draftsItem;

    public override void CollectViews()
    {
        base.CollectViews();
        draftsItem = root.GetComponentInParent<UgcAnimToneStoreItemView>();
    }
