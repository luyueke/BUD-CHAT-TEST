...
{
	public class AnimationStudioAdapter : GridAdapter<GridParams, AnimationStudioListViewsHolder>
	{
		...
		protected override void OnCellViewsHolderCreated(AnimationStudioListViewsHolder cellVH, CellGroupViewsHolder<AnimationStudioListViewsHolder> cellGroup)
		{
			base.OnCellViewsHolderCreated(cellVH, cellGroup);
			cellVH.IconRemoteImageBehaviour.InitializeWithPool(texturePool);
		}

		protected override void UpdateCellViewsHolder(AnimationStudioListViewsHolder newOrRecycled)
		{
			...
			switch (AnimationStudioType)
			{
				case AnimationStudioType.Animation:
					coverUrl = model?.animInfo?.cover;
					break;
				
				case AnimationStudioType.Pose:
					coverUrl = model?.poseInfo?.cover;
					break;
			}
	...
	public class AnimationStudioListViewsHolder : CellViewsHolder
	{
		public RemoteImageBehaviour IconRemoteImageBehaviour;
		public AnimationStudioItem StudioItem;
	
		public override void CollectViews()
		{
			base.CollectViews();
			IconRemoteImageBehaviour = GameObjectEx.FindChildByName(views, "AnimationItemIcon").GetComponent<RemoteImageBehaviour>();
