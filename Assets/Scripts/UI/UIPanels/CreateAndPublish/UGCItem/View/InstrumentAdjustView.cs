...
namespace UI {
    public class InstrumentAdjustView : UGCBaseStateView {
        ...
        private void OnReset() {
            avatarCommonData.ResetDef(instrumentEditData.GetSkinInfo());
        ...
        protected override void SyncEditData() {
            ...
            if (instrumentEditData != null) {
                if (string.IsNullOrEmpty(instrumentEditData.GetInfo().metaDataUrl)) {
                    instrumentEditData.GetInfo().metaDataUrl =
                        Es.DataTables.GetClothesTemplate(instrumentEditData.GetInfo().templateId).MetaDataUrl;
                }

                var skinInfo = instrumentEditData.GetSkinInfo();
                if (skinInfo != null && skinInfo.skinDetailInfo != null)
                {
                    ...
                    {
                        skinInfo.skinDetailInfo.size = instrumentEditData.size;
                    }
                }

                avatarCommonData = AvatarCommonData.From(instrumentEditData.skinActionDraftInfo._skinInfo);
        ...
        protected override void OnNextBtnClick() {
            instrumentEditData.skinActionDraftInfo._skinInfo.skinDetailInfo.pDef = pDef;
            instrumentEditData.skinActionDraftInfo._skinInfo.skinDetailInfo.rDef = rDef;
            instrumentEditData.skinActionDraftInfo._skinInfo.skinDetailInfo.sDef = sDef;
            base.OnNextBtnClick();
        }
        ...
        public List<RoleDataAdjust> AdjustTypeAdjustItems(AvatarCommonData configData) {
            var classType = UniqueType.GetUgcAvatar((AvatarSubType)instrumentEditData.GetSkinInfo().subType);
