...
namespace UI {
    public class PropSkinAdjustView : UGCBaseStateView {
            ...
            if (skinEditData != null) {
                if (string.IsNullOrEmpty(skinEditData.GetInfo().metaDataUrl)) {
                    skinEditData.GetInfo().metaDataUrl =
                        Es.DataTables.GetClothesTemplate(skinEditData.GetInfo().templateId).MetaDataUrl;
                }
                ...
                avatarCommonData = AvatarCommonData.From(skinEditData.draftInfo.baseInfo);
        ...
        public void ShowCharacter() {
            if (characterWrap != null) {
                saveCharacterData.ChangeSkinData(skinEditData.GetSkinInfo());
                characterWrap.ChangeUGCPart(skinEditData.GetSkinInfo());
                return;
            }
        ...
        public List<RoleDataAdjust> AdjustTypeAdjustItems(AvatarCommonData configData) {
            var classType = UniqueType.GetUgcAvatar((AvatarSubType)skinEditData.GetSkinInfo().subType);
