...
// 演员卡商城运营栏目视图：从 FittingRoom 的 Ugc+演员卡 流程迁出，结构与 MusicStoreSectionView 一致，
// 区别仅在于请求 sectionList 时 ugcType 传 ActorCard。
public class ActorCardStoreSectionView : MonoBehaviour
{
    ...
    public void RefreshData(UgcType ugcType = UgcType.ActorCard, Action<List<SectionItemData>> resultHandler = null)
    {
        JObject req = new JObject()
        {
            ["ugcType"] = (int)UgcType.ActorCard
        };
