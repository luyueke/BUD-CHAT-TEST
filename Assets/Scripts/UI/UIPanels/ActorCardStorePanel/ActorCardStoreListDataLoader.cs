...
// 演员卡商城列表数据加载器：结构与 MusicStoreListDataLoader 一致，
// 服务于演员卡(ActorCard) section 的分页拉取。item 的 ugcType 由服务端返回，
// RecommendItemData.UgcInfo 会据此反序列化为 OCTheatreAvatarInfo。
public class ActorCardStoreListDataLoader : MonoBehaviour
{
    ...
    {
        LoggerUtils.LogError("ActorCardStoreGetSectionInfoFail" + error);
    }
}
