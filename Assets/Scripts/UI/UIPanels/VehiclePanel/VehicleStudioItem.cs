...
public class VehicleStudioItem : MonoBehaviour
{
    ...
    public void InitSelectMode(DraftListItem data, Action<DraftListItem> onSelect, StudioSubType studioSubType)
    {
        ...
        else
        {
            ...
            if (_curData.vehicleInfo.paymentInfo != null)
            {
                price.SetText(_curData.vehicleInfo.paymentInfo.price.ToString());
                currencyIcon.sprite =
                    PgcUtils.LoadCurrencyIcon(_curData.vehicleInfo.paymentInfo.currencyType, gameObject);
            }
    ...
    private AuditResult GetAuditResult()
    {
        ...
        if (_curData.vehicleInfo != null && _curData.vehicleInfo.auditInfo != null)
        {
            auditResult = (AuditResult)_curData.vehicleInfo.auditInfo.auditResult;
        }
        return auditResult;
    }
