...
public class VehicleStudioInfoPanel : MonoBehaviour
{
    public VehicleStudioAdapter Adapter;
    public PullToRefreshBehaviour refreshController;
    public StudioSubType StudioType;
    private VehicleStudioDataLoader DataLoader = VehicleStudioDataLoader.Inst;
