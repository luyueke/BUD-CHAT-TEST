...
// 乐谱商城运营栏目视图：从 FittingRoom 的 Ugc+乐谱 流程迁出，结构与 TimbreStoreSectionView 一致，
// 区别仅在于请求 sectionList 时 ugcType 传 MusicScore。
public class MusicStoreSectionView : MonoBehaviour
{
    ...
    public void RefreshData(UgcType ugcType = UgcType.MusicScore, Action<List<SectionItemData>> resultHandler = null)
    {
        JObject req = new JObject()
        {
            ["ugcType"] = (int)UgcType.MusicScore
        };
