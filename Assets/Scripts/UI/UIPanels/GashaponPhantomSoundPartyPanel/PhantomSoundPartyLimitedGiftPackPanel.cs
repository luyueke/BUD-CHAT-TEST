...
public class PhantomSoundPartyLimitedGiftPackPanel : BasePanel<PhantomSoundPartyLimitedGiftPackPanel>
{
#if UNITY_ANDROID
    private const string ProductId168 = "android_budrongzhuyepifu168";
    private const string ProductId30  = "android_budrongtouxiangkuang30";
#else
    private const string ProductId168 = "ios_budrongzhuyepifu168";
    private const string ProductId30  = "ios_budrongtouxiangkuang30";
#endif
    ...
    {
        var list = IAPDataManager.Inst.productRes?.zzzPackageList;
        if (btn_168 != null)
        {
