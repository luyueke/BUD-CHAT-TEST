...
public class AIHospitalStoreManager: GlobalInstance<AIHospitalStoreManager>
{
    /// <summary>
    /// 商店配置信息
    /// </summary>
...
public class AIHospitalStoreItemData
{
    public int ID;
    ...
    /// 消耗的货币类型
    /// </summary>
    public int nCostCurrencyType;
    public int nCostAmount;
    public int nRemainCostTimes;
    public int nMaxCostTimes;
    public int nGoodsType;
    public string strDiscount;
    public int nTips;
    public string strUpdateCD;
    /// <summary>
    /// 奖励领取状态 是否拥有
    /// </summary>
