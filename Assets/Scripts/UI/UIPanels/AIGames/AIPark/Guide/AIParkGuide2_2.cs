...
//第二个事件
public class AIParkGuide2_2 : AIParkGuideBase
{
    ...
    public override void RunGuide()
    {
        ...
        AIParkGuideMgr.Inst.BootPanelGuide(AIGameParkConfig.EPgcGuideID.Event_2_2_1);
    }
    ...
    public override void TriggerNext()
    {
        ...
        {
            // 显示提莉亚的对话
            MessageHelper.Broadcast<string, string, Action>(MessageName.OnParkBeginNpcTalk, _tiliaNpc.GetNpcID(), "我感觉大家的反应有点奇怪，尤其是薇薇安和罗兰...你可以帮我去问一下乐园里的所有人怎么看到这个事件吗～", () =>
            {
