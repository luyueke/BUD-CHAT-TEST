...
// 姿势商城列表数据加载器：结构与 ActorCardStoreListDataLoader 一致，
// 服务于姿势(Pose) section 的分页拉取。item 的 ugcType 由服务端返回，
// RecommendItemData.UgcInfo 会据此反序列化为 PoseInfo。
public class PoseStoreListDataLoader : MonoBehaviour
{
    ...
    {
        LoggerUtils.LogError("PoseStoreGetSectionInfoFail" + error);
    }
}
