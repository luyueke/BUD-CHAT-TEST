...
public class CatGiftPackItem : MonoBehaviour
{
    ...
    private void ShowReward(ProductGemInfo productInfo)
    {
        ...
        if (productInfo.productId == "android_budumimiaozhuyepifu168" || productInfo.productId == "ios_budumimiaozhuyepifu168")
        {
            rewardItemDatas.Add(new CommonRewardItemData()
            {

                IconSp = ProfileThemeManager.Inst.LoadThemeIcon(19, gameObject),
                RewardAmount = 1,
                rewardName = "Umi主页皮肤"
            });
            rewardItemDatas.Add(new CommonRewardItemData()
        ...
        else if(productInfo.productId == "android_budumimiaotouxiangkuang30" || productInfo.productId == "ios_budumimiaotouxiangkuang30")
        {
            rewardItemDatas.Add(new CommonRewardItemData()
            {
                IconSp = UserUIWidgetManager.Inst.GetHeadCycleImg("HeadCycle_36_Pre", gameObject),
                RewardAmount = 1,
                rewardName = "Umi头像框"
            });
            rewardItemDatas.Add(new CommonRewardItemData()
