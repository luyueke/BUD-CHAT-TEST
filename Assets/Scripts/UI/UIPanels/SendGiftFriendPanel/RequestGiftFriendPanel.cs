...
public class RequestGiftFriendPanel : BasePanel<RequestGiftFriendPanel>
{
    ...
    public RequestGiftFriendListEntry RequestGiftFriendListEntry;
    ...
    public override void OnCreate()
    {
        ...
        RequestGiftFriendListEntry.AddClickListener(OnScrollViewClick);
        ...
        closeSearchButton.onClick.AddListener(() =>
        {
            ...
            RequestGiftFriendListEntry.GetFirstPageFriendDatas(OnHasFriends);
        });
    }
    ...
    private void SetupUI()
    {
        ...
        // productPrice.text = mData.Price.Value.ToString();
        RequestGiftFriendListEntry.SetData(mData, giftType,(goodsData, myFriendInfo) => 
        {
            string toUid = myFriendInfo.userInfo.uid;
            string giftId = goodsData.Id;
            RequestGiftInvoke(toUid, giftId, giftType);
        });
        loadingView.gameObject.SetActive(true);
        RequestGiftFriendListEntry.GetFirstPageFriendDatas(OnHasFriends);
    ...
    private void Search()
    {
        ...
        RequestGiftFriendListEntry.SearchGiftFriendDatas(this.searchContent, OnHasFriends);
    }
    
    private void RequestGiftInvoke(string toUid, string giftId, int giftType)
    {
        ...
        NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.RequestGift, HttpMethod.POST, JsonConvert.SerializeObject(req), (_) =>
        {
            TipPanel.ShowToast("索要成功");
            CloseSelf();
        }, (error) =>
        {
