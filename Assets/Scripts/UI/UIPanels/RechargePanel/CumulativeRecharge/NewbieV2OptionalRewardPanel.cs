...
{
    public class NewbieV2OptionalRewardPanel : BasePanel<NewbieOptionalRewardPanel>
    {
        ...
        public void SetStatus(int status)
        {
            switch (status)
            {
                ...
                case (int)EventStatus.Claim:
                    ...
                    Btn_Exchange.SetText("兑换");
                    break;
                case (int)EventStatus.Finish:
                    Btn_Exchange.gameObject.SetActive(true);
                    Btn_Exchange.SetText("已领取");
                    break;
        ...
        private string GetSpriteName(int itemIndex)
        {
            ...
            {
                case 0:
                    return "newbieV2_sign_reward1";
                case 1:
                    return "newbieV2_sign_reward2";
            }
        ...
        private void OnItemClick(NewbieCumulativeRechargeItem item, NewbieRewardData info, int itemIndex)
        {
            ...
            {
                itemName = "蓝盐海风泳衣";
                packPgcIds.Add("10400486");
                packPgcIds.Add("10200063");
            }
            else if (itemIndex == 1)
            {
                itemName = "粉夏晴天泳衣";
                packPgcIds.Add("10400485");
                packPgcIds.Add("10200063");
            }
