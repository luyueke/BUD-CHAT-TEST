...
public class ShiYuanPackPanel : BasePanel<ShiYuanPackPanel>
{
    ...
    void Start()
    {
        ...
        if (itemObj)
        {
            ...
            item?.InitCustomBgItem("#acd0ef", atlasPath,
                new List<string>()
                {
                    "shiyuan_bg_1", "shiyuan_bg_2", "shiyuan_bg_3", "shiyuan_bg_4"
                });
    ...
    private void TrackEvent(BillingResultResponse billingResultResponse)
    {
        ...
        if (isUploadData)
        {
            ...
            trackData.Add("method", "ShiYuanPackPanel");
    ...
    private void GenerateContent()
    {
        var ugcAsset =
            Loader.Load<TextAsset>(
                "Assets/Loadable/UI/RechargePanel/config/ShiYuanPackConfig.json", this.gameObject);
            ...
            IAPDataManager.Inst.GetProductInfo(res =>
            {
                ...
                if (paidPackageList != null && this != null)
                {
                    PaidPackageListItem packageListItem =
                        paidPackageList.Find(x => x.packageType == (int)PaidPackageType.WasabiPack);
                    if (packageListItem == null)
                    {
                        return;
                    }
