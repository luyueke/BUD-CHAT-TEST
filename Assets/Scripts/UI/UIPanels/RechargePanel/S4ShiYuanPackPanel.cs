...
public class S4ShiYuanPackPanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (itemObj)
        {
            ...
            item?.InitCustomBgItem("#C3E76F", atlasPath,
                new List<string>()
                {
                    "s4_shiyuan_bg_1", "s4_shiyuan_bg_2", "s4_shiyuan_bg_3","s4_shiyuan_bg_4"
                });
    ...
    private void GenerateContent()
    {
        var ugcAsset =
            Loader.Load<TextAsset>(
                "Assets/Loadable/UI/RechargePanel/config/S4ShiYuanPackConfig.json", this.gameObject);
            ...
            IAPDataManager.Inst.GetProductInfo(res =>
            {
                ...
                if (paidPackageList != null && this != null)
                {
                    PaidPackageListItem packageListItem =
                        paidPackageList.Find(x => x.packageType == 3);
                    if (packageListItem == null)
                    {
    ...
    public static void GetTaskList(Action ac) {
        IAPDataManager.Inst.GetProductInfo(res =>
        {
            ...
            if (paidPackageList != null)
            {
                ...
                {
                    IAPDataManager.Inst.GetTaskList("RainyRibbitPack", (b, taskInfoResponse) =>
                    {
    ...
    private void RefreshTaskStatus()
    {
        IAPDataManager.Inst.GetTaskList(_taskId, (b, taskInfoResponse) =>
        {
            ...
            for (int i = 0; i < startPackItems.Count; i++)
            {
                ...
                }, PaidPackageType.WeirdCorePack , tsTaskInfoData.taskStatus == 2);
            }
        });
    }
