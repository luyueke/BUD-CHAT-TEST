...
public class LiuYuanPackPanel : BasePanel<LiuYuanPackPanel>
{
    ...
    private string _taskId = "SixYuanPack";
    ...
    public override void OnCreate()
    {
        ...
        if (itemObj)
        {
            ...
            item?.InitCustomBgItem("#1f252e", atlasPath,
                new List<string>()
                {
                    "liuyuan_bg_1", "liuyuan_bg_2", "liuyuan_bg_3", "liuyuan_bg_4"
                });
    ...
    private void TrackEvent(BillingResultResponse billingResultResponse)
    {
        ...
        if (isUploadData)
        {
            ...
            trackData.Add("method", "LiuYuanPackPanel");
    ...
    private void GenerateContent()
    {
        var ugcAsset =
            Loader.Load<TextAsset>(
                "Assets/Loadable/UI/RechargePanel/config/LiuYuanPackConfig.json", this.gameObject);
            ...
            IAPDataManager.Inst.GetProductInfo(res =>
            {
                ...
                if (paidPackageList != null && this != null)
                {
                    PaidPackageListItem packageListItem =
                        paidPackageList.Find(x => x.packageType == (int)PaidPackageType.sixYuanPack);
                    if (packageListItem == null)
                    {
                        return;
                    }
