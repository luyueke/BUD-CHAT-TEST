...
public class LoverGiftViewItem : MonoBehaviour
{
    ...
    public void SetData()
    {
        productId = LoverGiftSystem.Inst.productIds[Id];

        var ls = IAPDataManager.Inst.productRes.loveFestivalPackageList;
    ...
    private void StartLoopingVerify()
    {
        ...
        PurchaseStatusManager.Inst.StartLoop(_curBudOrderId, (isOrderSuccess, productGemInfo) =>
        {
            ...
            // 已经买完了
            Claimed.gameObject.SetActive(transform);
