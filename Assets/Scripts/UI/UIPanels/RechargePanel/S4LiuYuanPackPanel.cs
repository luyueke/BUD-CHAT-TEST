...
public class S4LiuYuanPackPanel : BasePanel<S4LiuYuanPackPanel>
{
    ...
    private string _taskId = "Y2KPack";
    ...
    public override void OnCreate()
    {
        ...
        if (itemObj)
        {
            ...
            item?.InitCustomBgItem("#FF92CA", atlasPath,
                new List<string>()
                {
                    "s4_liuyuan_bg_1", "s4_liuyuan_bg_2", "s4_liuyuan_bg_3", "s4_liuyuan_bg_4"
                });
    ...
    private void TrackEvent(BillingResultResponse billingResultResponse)
    {
        ...
        if (isUploadData)
        {
            ...
            trackData.Add("method", "S4LiuYuanPackPanel");
    ...
    private void GenerateContent()
    {
        var ugcAsset =
            Loader.Load<TextAsset>(
                "Assets/Loadable/UI/RechargePanel/config/S4LiuYuanPackConfig.json", this.gameObject);
            ...
            IAPDataManager.Inst.GetProductInfo(res =>
            {
                ...
                if (paidPackageList != null && this != null)
                {
                    PaidPackageListItem packageListItem =
                        paidPackageList.Find(x => x.packageType == (int)PaidPackageType.Y2KPack);
                    if (packageListItem == null)
                    {
                        return;
                    }
