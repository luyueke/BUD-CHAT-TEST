...
public class SmannyPack : PackBaseView
{
    ...
    private void AdapterPackageUI()
    {
        ...
        rewardTips1.SetLocalText("{0}即可立刻获得",productInfo.priceLocal);
    }
    ...
    private void OnPreviewBtnClick()
    {
        EventRewardPanelData data = new EventRewardPanelData()
        {
            ...
            bgSpriteName = packViewConfig.bgSpriteName,
