...
public class TimbreStoreSectionView : MonoBehaviour
{
    ...
    public void RefreshData(UgcType ugcType = UgcType.MusicTone, Action<List<SectionItemData>> resultHandler = null)
    {
        JObject req = new JObject()
        {
            ["ugcType"] = (int)UgcType.MusicTone
        };
