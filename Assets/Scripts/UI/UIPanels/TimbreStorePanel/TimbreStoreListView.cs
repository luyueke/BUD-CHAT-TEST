...
public class TimbreStoreListView: MonoBehaviour 
{
    public TimbreStoreListAdapter adapter;
    private TimbreStoreListDataLoader requester = new TimbreStoreListDataLoader();
