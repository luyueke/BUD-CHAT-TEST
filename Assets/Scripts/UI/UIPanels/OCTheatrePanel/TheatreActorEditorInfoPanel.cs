...
{
    public class TheatreActorEditorInfoPanel : MonoBehaviour
    {
        public TheatreActorAdapter Adapter;
        public PullToRefreshBehaviour refreshController;
        public TheatreActorDataLoader DataLoader;
        ...
        {
            HideGizmo();
            Adapter.curActorType = actorType;
            DataLoader.InitData(actorType);
