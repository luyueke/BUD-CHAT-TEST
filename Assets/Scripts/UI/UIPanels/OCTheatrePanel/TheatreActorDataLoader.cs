...
using UnityEngine.Events;
    ...
    public class TheatreActorDataLoader : MonoBehaviour
    {
        protected ActorSubType _curActorSubType;
        ...
        public void InitData(ActorSubType type)
        {
            _curActorSubType = type;
            _reqHead = type == ActorSubType.Drafts
                ? HttpUrlDefine.ActorDraftList
