...
public class TheatreTriggerTheatreInfo : MonoBehaviour
{
    [SerializeField] public TheatreTriggerTheatreAdapter Adapter;
    [SerializeField] public PullToRefreshBehaviour refreshController;
    [SerializeField] public TheatreTriggerTheatreDataLoader DataLoader;
    [SerializeField] public GameObject emptyHint;
    ...
    private void OnGetFirstPage(List<DraftListItem> list)
    {
        ...
        Adapter.Refresh(false);
        emptyHint.SetActive(list == null || list.Count == 0);
    }
