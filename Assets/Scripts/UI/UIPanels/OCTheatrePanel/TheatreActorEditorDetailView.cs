...
public class TheatreActorEditorDetailView : MonoBehaviour
{
    ...
    private void OnBtnPublishClick()
    {
        ...
        NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.ActorPublish, HttpMethod.POST, JsonConvert.SerializeObject(req), OnPublishSuccess, OnPublishFail);
    }
    ...
    private void OnPublishFail(string failMsg)
    {
        LoggerUtils.LogError(failMsg);
    }
