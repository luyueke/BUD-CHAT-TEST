...
// #endif
        ...
        private static void inputExecute(int id, string json)
        {
            // MobileInterface.Instance.InputExecute(id, json);
        }

        private static void inputInit()
        {
            // MobileInterface.Instance.InputInit();
        }

        private static void inputDestroy()
        {
            // MobileInterface.Instance.InputDestroy();
        }
        ...
        /// </summary>
        private void Awake () {
            MessageHelper.AddListener(MessageName.ClickEmpty, OnClickEmpty);
        ...
        void OnDestroy()
        {
            MessageHelper.RemoveListener(MessageName.ClickEmpty, OnClickEmpty);
        }
        ...
        public static void Execute (int id, JsonObject data) {
            ...
            Debug.Log("MobileInput execute Type " + (json.GetType() == typeof(string))  + "   " + json);
#if UNITY_EDITOR
