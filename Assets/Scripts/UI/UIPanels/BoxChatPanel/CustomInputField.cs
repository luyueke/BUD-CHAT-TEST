        ...
        ILayoutElement
    {
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (TouchScreenKeyboardShouldBeUsed())
            {
                ...
                m_Keyboard = (inputType == InputType.Password) ?
                    KeyBoardTest.Open(m_Text, keyboardType, false, multiLine, true, false, "", characterLimit) :
                    KeyBoardTest.Open(m_Text, keyboardType, inputType == InputType.AutoCorrect, multiLine, false, false, "", characterLimit);
