...
public class ColorPink
{
    ...
    public static ColorPink colorPink => _colorPink ??= new ColorPink();
    ...
    public void UpdateChormaSprite(float H, float V)
    {
        Color[] colors = new Color[]
        {
    ...
    public void UpdateBrightSprite(float H, float S)
    {
        var leftColor = Color.HSVToRGB(H, S, 0);
        var rightColor = Color.HSVToRGB(H, S, 1);
        Color[] colors = new Color[]
        {
            leftColor,
            rightColor
