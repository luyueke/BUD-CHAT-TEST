...
public class FrostKeeperView : NewDefaultGashaponView
{
    ...
    {
        UIManager.Inst.OpenPanel(PanelId.RechargePanel, (int)RechargeId.LimitedRechargeGiftPack , 3);
    }
    ...
    protected override void OnGashaponInfoUpdate(GashaponInfoRsp infoRsp)
    {
        ...
        {
            windkeeperTip.SetText("恭喜！你已集霜寒守护者奖池所有奖品！");
