...
public class SnowDreamView : NewDefaultGashaponView {
    [SerializeField]
    ...
    protected override void InitBG() {
        ...
        item.InitCustomTextureBg("Assets/Loadable/UI/UIPanel/GashaponPanel/SnowDream/SnowDream.png");
