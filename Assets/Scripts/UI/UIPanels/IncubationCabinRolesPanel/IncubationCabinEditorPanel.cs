...
namespace UI.UIPanels.IncubationCabin
{
    ...
    public class IncubationCabinEditorPanel : BasePanel<IncubationCabinEditorPanel>
    {
        ...
        void OnColorBtnClick(int index)
        {
            ...
            for (int i = 0, C = colorBtns.Length; i < C; i++)
            {
                var colorBtn = colorBtns[i];
                colorBtn.transform.parent.Find("selectImg").gameObject.SetActive(i == index);
            }
            //设置颜色的http请求
        }
