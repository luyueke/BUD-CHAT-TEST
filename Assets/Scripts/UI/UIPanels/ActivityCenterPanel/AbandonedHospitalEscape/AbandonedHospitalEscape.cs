...
public class AbandonedHospitalEscape : ActivityBaseView
{
    [SerializeField] private AbandonedHospitalDailyView handDailyView;

    [SerializeField] private AbandonedHospitalDailyRewardItem rewardItemPrefab;
    ...
    private Dictionary<int, AbandonedHospitalDailyRewardItem> rewardItems =
        new Dictionary<int, AbandonedHospitalDailyRewardItem>();
    ...
    private List<string> pgcIds = new List<string>(){ "11000246"};
    ...
    private void ClaimAllReward()
    {
        ...
        NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.ClaimActivityReward,
            ...
            (content) =>
            {
                ...
                isSending = false;
                OnClaimAllSuccess(avtivityEventClaimResponse, BUDRewardType.RewardAIKey);
            },
    ...
    private void ShowPgcPreview()
    {
        ...
        panel.SetEventPreview(pgcIds,"药剂师试管", "","", "参与逃离废弃医院活动，免费领取药剂师试管", "##FF9B9B",bgImage.texture);
    }
