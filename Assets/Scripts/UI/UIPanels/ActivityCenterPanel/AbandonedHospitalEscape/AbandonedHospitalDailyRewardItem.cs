...
public class AbandonedHospitalDailyRewardItem : CommonRewardItem {
    private readonly Color normalColor = new Color32(229, 126, 121, 255);
    private readonly Color highlightColor = new Color32(80, 153, 241, 255);
    [SerializeField]
