...
public class CuteRabbitWarsView : ActivityBaseView {

    [SerializeField]
    private CuteRabbitWarsDailyView dailyView;
    ...
    private List<string> pgcIds = new List<string>(){ "11000064"};
    ...
    private void ShowPgcPreview()
    {
        ...
        panel.SetEventPreview(pgcIds,"萌兔玩偶", "","", "参与活动收集胡萝卜，免费领取萌兔玩偶", "#FF9A61",bgImage.texture);
    }
    ...
    private void OnClaimAllBtnClick()
    {
        ...
        NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.ClaimActivityReward,
            ...
            (content) =>
            {
                ...
                isSending = false;
                OnClaimAllSuccess(avtivityEventClaimResponse, BUDRewardType.RewardCarrot);
            },
