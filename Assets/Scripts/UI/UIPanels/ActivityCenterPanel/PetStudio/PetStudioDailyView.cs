...
public class PetStudioDailyView : MonoBehaviour
{
    [SerializeField] private Transform content;
    [SerializeField] private PetStudioDailyItemView _itemView;
    ...
    private void OnClaimSuccess(ActivityEventClaimResponse response)
    {
        ...
        ClaimSuccessAction?.Invoke(PetStudioJumpType.Daily, response);
    }
}
