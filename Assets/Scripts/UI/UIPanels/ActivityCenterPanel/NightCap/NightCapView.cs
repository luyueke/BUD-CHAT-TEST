...
public class NightCapView : ActivityBaseView
{
    [SerializeField] private NightCapDailyView handDailyView;

    [SerializeField] private NightCapRewardItem rewardItemPrefab;
    ...
    [SerializeField] private CButton nightCapBtn;

    private readonly List<int> rewardEventIds = new List<int>() { 11,12, 13, 14, 15, 16 };

    private Dictionary<int, NightCapRewardItem> rewardItems =
        new Dictionary<int, NightCapRewardItem>();
    ...
    public override void Init(ActivityInfo info)
    {
        ...
        nightCapBtn.onClick.AddListener(() =>
        {
            //todo
    ...
    private void ClaimAllReward()
    {
        ...
        NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.ClaimActivityReward,
            ...
            (content) =>
            {
                ...
                isSending = false;
                OnClaimAllSuccess(avtivityEventClaimResponse, BUDRewardType.RewardNightCap);
            },
    ...
    private void ShowAvatarFrame(CommonRewardItemData commonRewardItemData)
    {
        ...
        // panel.UpdateUI(commonRewardItemData.IconSp, "瞌睡头像框", null, "参与睡帽梦工厂活动获得", isAvatarFrame:true);
    }
