...
public class VotingFunView : ActivityBaseView
{
    [SerializeField] private List<VotingFunItemView> _itemViews;
    ...
    public override void Init(ActivityInfo info)
    {
        ...
        InitBg(bgParent, "#673EB8",new List<string>()
        {
            "VotingFun_1",
            "VotingFun_2"
        });
    ...
    private void InitEventBaseInfo(ActivityInfo info)
    {
        ...
        {
            LoggerUtils.LogError("[EditAvatar] init Event ItemView fail");
            return;
        }
