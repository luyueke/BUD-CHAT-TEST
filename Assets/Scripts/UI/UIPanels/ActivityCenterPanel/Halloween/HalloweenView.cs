...
public class HalloweenView : ActivityBaseView
{
    [SerializeField] private Transform content;
    [SerializeField] private HalloweenItemView _itemView;
    [SerializeField] private CButton rewardBtn;
    [SerializeField] private EventCurrencyView currencyView;
    
    private List<HalloweenItemView> eventViews = new List<HalloweenItemView>();
    ...
    public override void Init(ActivityInfo info)
    {
        ...
        InitBg(bgParent, "#463F40",new List<string>()
        {
            "Halloween_1",
            "Halloween_2",
            "Halloween_3"
    ...
    private void InitListUI(List<ActivityEventInfo> datas)
    {
        ...
        for (int i = 0; i < datas.Count; i++)
        {
            ...
            HalloweenItemView eventItem = obj.GetComponent<HalloweenItemView>();
    ...
    private void ShowExchangePage()
    {
        ...
        var panel = UIManager.Inst.OpenPanel<HalloweenRewardPanel>(PanelId.HalloweenRewardPanel);
