...
public class BundleOnlineRewardPanel : BasePanel<BundleOnlineRewardPanel>
{
    ...
    [SerializeField] private BundleOnlineRewardItemView _item;
    private List<BundleOnlineRewardItemView> itemViews = new List<BundleOnlineRewardItemView>();
    ...
    private void InitUI()
    {
        ...
        item.InitCustomBgItem("#9E00FF", atlasPath, new List<string>()
        {
            "BundleOnline_1", "BundleOnline_2", "BundleOnline_3"
        });
