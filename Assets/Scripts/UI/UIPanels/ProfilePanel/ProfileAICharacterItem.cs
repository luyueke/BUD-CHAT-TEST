...
{
    public class ProfileAICharacterItem : MonoBehaviour
    {
        ...
        private CabinCharacterUgcInfo _info;
        private Action<CabinCharacterUgcInfo> _onClick;
        ...
        public void SetData(CabinCharacterUgcInfo info, Action<CabinCharacterUgcInfo> onClick)
        {
            _info = info;
            _onClick = onClick;
