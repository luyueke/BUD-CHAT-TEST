...
{
    public class ProfileToneDataLoader : ProfileCommonDataLoader
    {
        ...
        public override void GetPublishList(Action<bool, List<DraftListItem>> resultAction)
        {
            ...
            NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.UGCTonePublishList, HttpMethod.GET, JsonConvert.SerializeObject(req), (content) =>
                {
