...
{
    public class ProfilePetPoseDataLoader : ProfileCommonDataLoader
    {
        ...
        public override void GetPublishList(Action<bool, List<DraftListItem>> resultAction)
        {
            ...
            NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.posePublishList, HttpMethod.GET, JsonConvert.SerializeObject(req), (content) =>
                {
