...
{
    public class VehicleCard : BaseCard
    {
        ...
        {
            if (data != null && data.vehicleInfo != null)
            {
                UIManager.Inst.SwapPanel(PanelId.AssetDetailPanel, AssetDetailType.Vehicle, data.vehicleInfo.id, data.vehicleInfo.ugcStyle);
            }
        }
