...
{
    public class GameHallFriendAdapter: OSA<BaseParamsWithPrefab,GameHallFriendItemHolder>,IPointerClickHandler
	{
		...
		/// <inheritdoc/>
		protected override GameHallFriendItemHolder CreateViewsHolder(int itemIndex)
		{
			var instance = new GameHallFriendItemHolder();
		...
		protected override void UpdateViewsHolder(GameHallFriendItemHolder newOrRecycled)
		{
	...
	public class GameHallFriendItemHolder : BaseItemViewsHolder
	{
		public RemoteImageBehaviour iconRemoteImageBehaviour;
		public GameHallFriendItem MyFriendItem;
		public override void CollectViews()
		{
			base.CollectViews();
			root.GetComponentAtPath("Item/Icon", out iconRemoteImageBehaviour);
			MyFriendItem = root.GetComponent<GameHallFriendItem>();
			MyFriendItem.Init();
		}

		public void UpdateViews(MyFriendsInfo model)
		{
			MyFriendItem.SetData(model);
		}
	}
}