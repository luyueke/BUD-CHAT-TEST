...
public class UMIMusicalPudingPanel : BaseGashaponView
{
    ...
    public override void OnShow()
    {
        ...
        if (pendingId == "lottery.musicalPuddingSuit" || pendingId == "lottery.musicalPudding.prank")
        {
            SuitToggle_0.isOn = true;
        }
        if (pendingId == "lottery.musicalPudding.umi")
        {
            SuitToggle_1.isOn = true;
        }
        if (pendingId == "lottery.musicalPudding.didu")
        {
    ...
    private void InitData(int type = 0)
    {
        ...
        if(string.IsNullOrEmpty(CurRewardList.BundleId))
        {
            PgcUtils.LoadAvatarIconAsync(CurRewardList.CenterRewarId, gameObject, (iconSprite) =>
            {
                if (iconSprite != null)
                {
                    ...
                    BigRewardIcon_0.SetNativeSize();
                    BigRewardText_0.text = "音符恶作剧";
                }
            });
        }
        else
        {
            PgcUtils.LoadBundleIconAsync(CurRewardList.BundleId, gameObject, (iconSprite) =>
            {
                ...
                {
                    BigRewardIcon_0.sprite = iconSprite;
                    BigRewardText_0.text = m_CurSelectType == 1 ? "Umi套装" : "Didu套装";
                }
            });
        }
    ...
    private SuitRewardInfo GetCurTypeIdList()
    {
        switch(m_CurSelectType)
        {
            case 0: 
                ...
                {
                    CenterRewarId = "11400084",
                    BundleId = "",
                    SuitRewardId_0 = "40200510",
                    SuitRewardId_1 = "40200511",
                    SuitRewardId_2 = "40200512",
                };
            case 1: 
                return new SuitRewardInfo()
                {
                    CenterRewarId = "",
                    BundleId = "123",
                    SuitRewardId_0 = "40200513",
                    SuitRewardId_1 = "40200515",
                    SuitRewardId_2 = "40200518",
                };
            case 2:
                return new SuitRewardInfo()
                {
                    CenterRewarId = "",
                    BundleId = "124",
                    SuitRewardId_0 = "40200514",
                    SuitRewardId_1 = "40200516",
                    SuitRewardId_2 = "40200519",
                };
        }
    ...
    {
        var rulePath = "Assets/Loadable/UI/UIPanel/SecMusicPuddingPanel/Rule.json";
    ...
    private void OnUpdateExtraTask(GashaponTaskRewardRsp rewardRsp)
    {
        ...
        commonRewardItemData.IconSp = XAssetLoaderMgr.Inst.LoadSpriteInAltas(altas, "ShowBubble_22", gameObject);
        commonRewardItemData.rewardName = "Umi限定聊天气泡";
    ...
    private string GetGashaponIdByType()
    {
        ...
        {
            case 0:
                typeId = "lottery.musicalPudding.prank";
                break;
            case 1:
                typeId = "lottery.musicalPudding.umi";
                break;
            case 2:
                typeId = "lottery.musicalPudding.didu";
                break;
        }
        return typeId;
    }
