...
{
    public class FriendsRequestListAdapter: OSA<BaseParamsWithPrefab,FriendsRequestListItemHolder>,IPointerClickHandler
	{
		...
		/// <inheritdoc/>
		protected override FriendsRequestListItemHolder CreateViewsHolder(int itemIndex)
		{
			var instance = new FriendsRequestListItemHolder();
			instance.Init(_Params.ItemPrefab, _Params.Content, itemIndex);
			return instance;
		}
		
		
		protected override void UpdateViewsHolder(FriendsRequestListItemHolder newOrRecycled)
		{
	...
	public class FriendsRequestListItemHolder : BaseItemViewsHolder
	{
		public FriendRequestListItem FriendRequestListItem;
		public override void CollectViews()
		{
			base.CollectViews();
			FriendRequestListItem = root.GetComponent<FriendRequestListItem>();
		}

		public void UpdateViews(MyFriendsInfo model)
		{
			FriendRequestListItem.SetData(model);
		}
	}
}