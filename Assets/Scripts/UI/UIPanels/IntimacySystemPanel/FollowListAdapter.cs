...
{
    public class FollowListAdapter: OSA<BaseParamsWithPrefab,FollowItemHolder>,IPointerClickHandler
	{
		...
		/// <inheritdoc/>
		protected override FollowItemHolder CreateViewsHolder(int itemIndex)
		{
			var instance = new FollowItemHolder();
			instance.Init(_Params.ItemPrefab, _Params.Content, itemIndex);
			return instance;
		}
		
		
		protected override void UpdateViewsHolder(FollowItemHolder newOrRecycled)
		{
	...
	public class FollowItemHolder : BaseItemViewsHolder
	{
		public FollowListItem FriendRequestListItem;
		public override void CollectViews()
		{
			base.CollectViews();
			FriendRequestListItem = root.GetComponent<FollowListItem>();
