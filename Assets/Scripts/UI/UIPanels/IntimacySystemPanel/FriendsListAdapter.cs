...
{
    public class FriendsListAdapter: OSA<BaseParamsWithPrefab,FriendsListItemHolder>,IPointerClickHandler
	{
		...
		/// <inheritdoc/>
		protected override FriendsListItemHolder CreateViewsHolder(int itemIndex)
		{
			var instance = new FriendsListItemHolder();
			instance.Init(_Params.ItemPrefab, _Params.Content, itemIndex);
			return instance;
		}
		
		
		protected override void UpdateViewsHolder(FriendsListItemHolder newOrRecycled)
		{
	...
	public class FriendsListItemHolder : BaseItemViewsHolder
	{
		public FriendListItem FriendListItem;
		public override void CollectViews()
		{
			base.CollectViews();
			FriendListItem = root.GetComponent<FriendListItem>();
			FriendListItem.Init();
		}

		public void UpdateViews(MyFriendsInfo model)
		{
			FriendListItem.SetData(model);
		}
	}
}