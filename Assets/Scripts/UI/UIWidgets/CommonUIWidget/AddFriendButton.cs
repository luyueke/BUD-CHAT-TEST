...
public class AddFriendButton : CommonUIWidget
{
    private string _uid;
    ...
    private void Start()
    {
        _loadingButton.onClick.AddListener(AddFriend);
    }
    ...
    private void AddFriend()
    {
        ...
        if (relationStatus == (int)RelationStatusType.None || relationStatus == (int)RelationStatusType.Reve)
        {
            ...
            NetworkManager.Inst.SendHttpRequest(HttpUrlDefine.setRelation, HttpMethod.POST,
                ...
                OnAddFriendSuccess, OnAddFriendFail);
        }
    }

    private void OnAddFriendSuccess(string message)
    {
        ...
        MessageHelper.Broadcast(MessageName.AddFriendSuccess);
    }

    private void OnAddFriendFail(string message)
    {
        _loadingButton.HideLoading();
